...
export function createTerminal(
  ...
  const term = new Terminal({
    ...
    cursorStyle: 'block',
    theme: THEME,
    windowsPty: opts.windowsBuild
      ? { backend: 'conpty', buildNumber: opts.windowsBuild }
      : undefined
  })
  ...
  let rendererKind: 'webgl' | 'dom' = 'dom'
  try {
  ...
  term.focus()
  return { term, serialize, fit, rendererKind, element: container, lastWheel: () => wheel }
}
